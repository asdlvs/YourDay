...
<div>
<asp:Label ID="LabelEMail" runat="server" Text="Label">E-mail</asp:Label>
</div>
<div>
<asp:TextBox runat="server" ID="TextBoxEMail" ClientIDMode="Static"></asp:TextBox>
</div>
<br />
<div>
...
<asp:CheckBox runat="server" ID="CheckBoxRememberMe"  ClientIDMode="Static"/>
</div>
<div class="cell checkboxlabel">
<asp:Label ID="LabelRememberMe" runat="server" Text="Label">Запомнить меня</asp:Label>
</div>
<div class="cell forgetpwd">
<asp:HyperLink runat="server" ID="HyperlinkForgetPassword">Забыли пароль?</asp:HyperLink>
</div>
<br /><br /><br />
<div class="button">
